...
The paper uses the current development version of `plyranges` which you can install from github using:
...
#>  GenomicRanges          * 1.32.2    2018-05-06
