...
* replacing arguments with functions
* standardised inputs for reading/writing genomics data as GRanges objects
...
endmoprhism in the `plyranges` DSL enables a user to predict the structure of 
