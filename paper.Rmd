...
and the `BioStrings` package (2.49.0) installed \cite{r-core, plyranges-zenodo, R-biostrings}. 
...
and pull requests. This article was written with `knitr` \cite{R-knitr} and 
the figures were made with `ggbio` \cite{R-ggbio}.
