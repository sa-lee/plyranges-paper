...
# Genotype Files accross h1 cell line methylation marks
h1_geno <- "data/GSM1463263_JS-ESCH1.txt.gz"
...
`knitr` @R-knitr and the figures were made with `ggbio` @R-ggbio.
