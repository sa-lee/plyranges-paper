...
comparsion to Bioconductor API here?
...
action on a GRanges object. The `plyranges` DSL implments the core verbs from the `dplyr` package
and implements context specific verbs for transforming GRanges objects (described in
table ). Each verb preserves the semantics of GRanges object and via
duck typing works with derivatives of the GRanges class. 
