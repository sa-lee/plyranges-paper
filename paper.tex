...
\ref{tab:grammar}). {[}ML: add a couple overview sentences indicating
the classes of operations like arithmetic, merging, aggregation{]}
...
integrity of the object. We introduce the \emph{anchor} combinator to
