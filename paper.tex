...
\NormalTok{ggbio}\OperatorTok{::}\KeywordTok{autoplot}\NormalTok{(peak_region, }
                \KeywordTok{aes}\NormalTok{(}\DataTypeTok{y =}\NormalTok{ score), }
                \DataTypeTok{geom =} \StringTok{"blank"}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{geom_area}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ start))}
\end{Highlighting}
\end{Shaded}

\begin{figure}

{\centering \includegraphics{paper_files/figure-latex/peak_region-1} 
